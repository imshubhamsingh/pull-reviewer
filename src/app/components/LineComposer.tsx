...
import { AskAiPanel, type AskContext } from '@/app/components/AskAiPanel'
...
export function LineComposer({ initial = '', rangeLabel, askContext, onAskStream, onSave, onCancel, saveLabel = 'Add comment' }: Props): JSX.Element {
  ...
  return (
    <div className="border-border bg-surface mx-3 my-1 rounded-md border p-2">
      {rangeLabel && (
        <p className="text-text-muted mb-1 text-[10px] tracking-wider uppercase">Comment on {rangeLabel}</p>
      )}
